...
Route::middleware('auth')->group(function () {
    ...
    Route::post('matkul-pengajar/upload-sk', [MatkulPengajarController::class, 'uploadSk'])->name('matkul-pengajar.upload-sk');
    Route::get('matkul-pengajar/sk/{skPeriode}', [MatkulPengajarController::class, 'downloadSk'])->name('matkul-pengajar.sk-download');
