...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Tambah Unsur Penilaian</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Form Input Unsur Penilaian</h4>
                    <p class="text-muted mb-3">Silakan isi form berikut untuk menambahkan unsur penilaian baru.</p>

                    <form action="{{ route('unsur-penilaian.store') }}" method="POST">
                        @csrf
                        
                         <div class="form-group row">
                            <label for="kode_nomor" class="col-sm-2 col-form-label text-right">Kode Nomor</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="{{ old('kode_nomor') }}" id="kode_nomor" name="kode_nomor" placeholder="Contoh: A.1, I.A, dsb" required>
                                @error('kode_nomor')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="{{ old('nama_unsur') }}" id="nama_unsur" name="nama_unsur" placeholder="Masukkan nama unsur penilaian" required>
                                @error('nama_unsur')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="is_header" name="is_header" value="1" {{ old('is_header', true) ? 'checked' : '' }}>
